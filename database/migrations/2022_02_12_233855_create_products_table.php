    ...
    public function up()
    {
        ...
        DB::table('products')->insert(
            [
                ...
                ['name' => 'Fifty Shades of Grey', 'category' => 'Books', 'price' => 13.99, 'image' => 'fifty_shades_of_grey.jpg', 'description' => 'Fifty Shades of Grey is a 2011 erotic romance novel by British author E. L. James.[1] It became the first instalment in the Fifty Shades novel series that follows the deepening relationship between a college graduate, Anastasia Steele, and a young business magnate, Christian Grey.'],
                ['name' => 'PlayStation 5', 'category' => 'Electronics', 'price' => 499.99, 'image' => 'ps5.jpg', 'description' => 'The PlayStation 5 (PS5) is a home video game console developed by Sony Interactive Entertainment.'],
                ['name' => 'Bulova Dark Dial Mens Watch 5', 'category' => 'Jewellery & Watches', 'price' => 179.99, 'image' => 'bulova.jpg', 'description' => 'High-performance technology and enduring quality, following the Bulova tradition.'],
                ['name' => 'BCalvin Klein High Noon Quartz Watch', 'category' => 'Jewellery & Watches', 'price' => 149.99, 'image' => 'calvin_klein_watch.jpg', 'description' => 'The Calvin Klein Posh Chronograph watch, comes with a stainless steel case that offers water resistance of 50 meters. The case measures 42 mm in diameter and is presented on a black leather strap, secured on the wrist with a tang buckle.'],
                ['name' => 'Burei Ultra Thin Black Mens Watch', 'category' => 'Jewellery & Watches', 'price' => 69.99, 'image' => 'burei_watch.jpg', 'description' => ':Quartz movement PE46 and battery provide precise time keeping. Little sub-dial located at 6 oclock for the seconds display.'],
